...
class ProcessConfig(Config):
    ...
    def tag_updates_queue_name(self):
        """
        Gets the name of queue used for tag updates, specified by the TAG_UPDATES_QUEUE_NAME property
        """
    ...
    def queue_type(self):
        """
        Gets the type of queue currently being used, specified by the QUEUE_TYPE property
    ...
    def storage_container_type(self):
        """
        Gets the type of storage container currently being used, specified by the STORAGE_CONTAINER_TYPE property
    ...
    def resource_storage_type(self):
        """
        Gets the type of resource storage currently being used, specified by the RESOURCE_STORAGE_TYPE property

        Acceptable values:
            'elastic_search'
            'azure_cosmos_table'
            'mysql'
            'rest_storage_service' (REST_STORAGE_URL must also be specified)
        """
    ...
    def rest_storage_url(self):
        """
        Gets the URL for the Rest storage service if being used, specified by the REST_STORAGE_URL property
        """
    ...
    def batch_size(self):
        """
        Gets the batch size of resources to send to the storage service, specified by the RESOURCE_BATCH_SIZE property
        Defaults to 16
        """
