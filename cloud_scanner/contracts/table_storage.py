...
class TableStorage(ABC):
    ...
    def write_entries(self, entries):
        """
        Write collection of entries to Table Storage
        Not implemented in this class
        """
    ...
    def query_list(self) -> list:
        """
        Get list of all entries in table storage
        Not implemented in this class
        """
    ...
    def query(self, partition_key, row_key):
        """
        Query Table Storage for specific entry
        Not implemented in this class
        """
    ...
    def delete(self, partition_key, row_key):
        """
        Delete specific entry in Table Storage
        Not implemented in this class
        """
